...
\begin{lem}
\textnormal{\upcite{The-super-connectivity-of-augmented-cubes}}
...
\begin{defn}
\textnormal{\upcite{The-g-extra-conditional-sequential}}
...
\textnormal{(2)} $AQ_n-F$包含两个连通分支，其中一个包含一个顶点个数为$3$的连通分支，另一个是包含顶点个数为$2^n-|F|-3$的连通分支。
\end{lem}
