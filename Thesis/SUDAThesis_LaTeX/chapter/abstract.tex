...
扩展立方体是著名互连网络超立方体拓扑结构的一种重要变体。它不仅保留了超立方体的许多优秀的性质，同时拥有超立方体和它的其他变体所不具备的优点，比如，$n$-维扩展立方体的连通度是$2n-1$，几乎是超立方体的两倍，这也意味着扩展立方体的容错性能在一些方面优于超立方体。
...
3倍。此外，本文也给出了扩展立方体在MM$^*$模型下的$2$-额外诊断算法，算法分析和模拟实验表明该算法可以正确诊断出所有的故障顶点。
...
\keywords{高性能计算，扩展立方体，结构连通度，子结构连通度，额外诊断度，容错路由算法，诊断算法}
